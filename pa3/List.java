...
/*Ashley Lavizadeh
  alavizad
  pa3
  List ADT from pa1 that takes objects instead of ints 
 */ 
 ...
 //---Manipulation prcedures------
  ...
  void prepend(Object data){ //conditions for adding at the end?
    if(length == 0){
  ...
  void insertBefore(Object data){    //question, do I want the cursor position to stay the
    if( length == 0 ){
      throw new RuntimeException(
